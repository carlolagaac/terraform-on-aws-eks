...
Observations: 
1) Should fail with not creating EC2 Instance in 1 availability zone in region ap-southeast-1
...
```t
Error: Error launching source instance: Unsupported: Your requested instance type (t3.micro) is not supported in your requested Availability Zone (ap-southeast-1e). Please retry your request by not specifying an Availability Zone or choosing ap-southeast-1a, ap-southeast-1b, ap-southeast-1c, ap-southeast-1d, ap-southeast-1f.
